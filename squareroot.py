...
# x ** .5 or math.sqrt(x). This is to demonstrate that you can research and code a process
# (If you really needed the square root you would use one of the above methods).
